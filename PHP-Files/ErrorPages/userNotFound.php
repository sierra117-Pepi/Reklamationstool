            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Userkann nicht einlgeloggt werden
                    </div>
                    <!-- /.panel-heading -->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="profile-pills">
                                <div class="alert alert-danger">
                                    <p>User kann nicht gefunden werden</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="messages-pills">
                                <div class="alert alert-info">
                                    <p>Bitte überprüfen Sie die eingabedaten.</p>
                                    <p>Falls diese stimmen und Sie trotzdem noch die selbe Fehler bekommen, dann haben Sie keine Registrierung.</p>
                                    <p>Bitte kontaktieren Sie uns diesbezüglich.</p>
                                </div>
                            </div>
